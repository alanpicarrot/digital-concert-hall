...
public class AdminUserInitializer implements CommandLineRunner {
    ...
    private void initAdminUser() {
        ...
        if (userRepository.findByUsername(adminUsername).isPresent() ||
            ...
            // 創建管理員帳號
            User adminUser = new User(adminUsername, adminEmail, passwordEncoder.encode(adminPassword)); // 確保構造函數參數匹配
            ...
            adminUser.setRoles(new HashSet<>(Arrays.asList(adminRole))); // 確保方法存在
